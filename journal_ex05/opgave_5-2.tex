...
Som forventet er opstår der latches i vores \texttt{latch} modul, og disse må være uundgåelige i denne sammenhæng - der skal jo være noget der kan indeholde værdien af den hemmelige værdi, og da vi ikke umiddelbart har hukommelse tilgængeligt, må latches være vejen frem.
