...
\begin{figure}[H]
    ...
    \caption{RTL view for den samlede \texttt{watch entity}}\label{fig:ex6-4-fotos}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Fotos der viser de forskellige tidspunkter.}\label{fig:ex6-4-fotos}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\emph{Rollover} implementationen, der viser overgang m. \texttt{[23:59:59]->[00:00:00]}.}\label{fig:ex6-4-fotos}
\end{figure}
