{
    ...
    Da parene for 1'er og 10'er counters fungerer ens for sekunder, minutter og timer, har vi for nemheds skyld indkapslet dem en entity til at håndtere begge samtidig, denne ses på \coderef[\labelprefix]{ex06/vhdl/TwoCounters.vhd}.
