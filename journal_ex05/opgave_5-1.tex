{
    ...
    \includecode[\labelprefix]{ex05/vhdl/bin2hex.vhd}{Binary to 7-segment entity og arkitektur}{linerange={5-36}, language=vhdl}
    ...
    \dsdtab{
        ...
        \includecode[\labelprefix]{ex05/vhdl/bin2hex_tester.vhd}{[Test bench: Binary to 7-segment] Test bench setup, hvori Binary to 7-segment afprøves}{}
