{
    ...
    Decoderen blev designet på samme måde som i Øvelse 4, og med de samme betingelsesværdier, dog med en \texttt{CASE} i stedet. De to syntakser minder om hinanden, men der er dog nogle forskelle. Implementationen ses i \coderef[\labelprefix]{ex05/vhdl/bin2hex.vhd}

    \includecode[\labelprefix]{ex05/vhdl/bin2hex.vhd}{Binary to 7-segment entity og arkitektur}{linerange={5-36}}
    ...
    For at teste funktionaliteten blev der også lavet en testcase, denne ses i \tabref{7segmentTestCase}, og dens testbench kode ses i \coderef[\labelprefix]{ex05/vhdl/bin2hex_tester.vhd}
    ...
    \dsdtab{
        ...
        \includecode[\labelprefix]{ex05/vhdl/bin2hex_tester.vhd}{[Test bench: Binary to 7-segment] Test bench setup, hvori Binary to 7-segment afprøves}{linerange={6-23}}
